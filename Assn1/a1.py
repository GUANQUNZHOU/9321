...
def q2():
    ...
    '''
    accident_file = pd.read_csv('accidents_2017.csv',float_precision = 'high')
    ...
    #result.to_csv('resuq2.csv',index = False)
...
def q4():
    ...
    air_file_filter = air_file.loc[:9,['Station','District Name']]
    ...
    air_quality = pd.read_csv('air_quality_Nov2017.csv',float_precision = 'high')
    ...
    df2 = pd.read_csv('air_stations_Nov2017.csv',float_precision = 'high')
    ...
    dff2 = pd.read_csv('result_q2.csv',float_precision = 'high')
